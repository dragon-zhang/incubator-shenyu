 ...
 */
public abstract class AbstractFilteredWasmPlugin extends AbstractWasmPlugin {
    ...
    protected abstract Mono<Void> doExecute(ServerWebExchange exchange, ShenyuPluginChain chain, SelectorData selector, RuleData rule, Object[] results);
    ...
    /**
     * print selector log.
     * please don't delete this method or refactor {@linkplain org.apache.shenyu.plugin.wasm.base.AbstractFilteredWasmPlugin#printLog}
